...
def load_domain_data(apps, schema_editor):
    ...
    roles_data = [
        ...
        {
            "id": 1,
            "nomeperfil": "Usuario do Portal",
            "codigoperfil": "USER_PORTAL",
            "aplicacao_id": 1,
        },
        {
            "id": 4,
            "nomeperfil": "Gestor do Portal",
            "codigoperfil": "GESTOR_PORTAL",
            "aplicacao_id": 1,
        },
        # CARGA_ORG_LOT
        {
            "id": 2,
            "nomeperfil": "Gestor Carga Org/Lot",
        ...
        },
        {
            ...
            "codigoperfil": "COORDENADOR_CARGA",
            "aplicacao_id": 2,
        },
        {
            "id": 21,
            "nomeperfil": "Analista - Upload e Validação",
            "codigoperfil": "ANALISTA_CARGA",
            "aplicacao_id": 2,
        },
        {
            "id": 22,
            "nomeperfil": "Consultor - Apenas Leitura",
            "codigoperfil": "VISUALIZADOR_CARGA",
            "aplicacao_id": 2,
        },
        # ACOES_PNGI
        {
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(load_domain_data, reverse_code=reverse_migration),
    ]
