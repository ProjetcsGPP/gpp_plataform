...
from accounts.models import Attribute, Role, User, UserRole
...
class UserSerializer(serializers.ModelSerializer):
    ...
    def get_roles(self, obj: User) -> list:
        ...
        user_roles = UserRole.objects.filter(
            user=obj, aplicacao__codigointerno=app_code
        ).select_related("role")

        return [
            {"id": ur.role.id, "code": ur.role.codigoperfil, "name": ur.role.nomeperfil}
    ...
    def _get_app_code(self) -> str | None:
        """
