...
class PatriarcaSerializer(serializers.ModelSerializer):
    ...
    status_progresso_descricao = serializers.CharField(
        source="id_status_progresso.str_descricao", read_only=True
    )
...
class OrganogramaVersaoSerializer(serializers.ModelSerializer):
    ...
    patriarca_nome = serializers.CharField(
        source="id_patriarca.str_nome", read_only=True
    )
...
class OrgaoUnidadeSerializer(serializers.ModelSerializer):
    ...
    pai_sigla = serializers.CharField(
        source="id_orgao_unidade_pai.str_sigla", read_only=True, allow_null=True
    )
    pai_nome = serializers.CharField(
        source="id_orgao_unidade_pai.str_nome", read_only=True, allow_null=True
    )
    ...
    def validate(self, attrs):
        ...
        if pai:
            patriarca = attrs.get(
                "id_patriarca", getattr(self.instance, "id_patriarca", None)
            )
            versao = attrs.get(
                "id_organograma_versao",
                getattr(self.instance, "id_organograma_versao", None),
            )
...
class OrganogramaJsonSerializer(serializers.ModelSerializer):
    ...
    organograma_versao_id = serializers.IntegerField(
        source="id_organograma_versao.id_organograma_versao", read_only=True
    )
    patriarca_sigla = serializers.CharField(
        source="id_organograma_versao.id_patriarca.str_sigla_patriarca", read_only=True
    )
...
class LotacaoSerializer(serializers.ModelSerializer):
    ...
    orgao_sigla = serializers.CharField(
        source="id_orgao_lotacao.str_sigla", read_only=True
    )
    orgao_nome = serializers.CharField(
        source="id_orgao_lotacao.str_nome", read_only=True
    )
    unidade_sigla = serializers.CharField(
        source="id_unidade_lotacao.str_sigla", read_only=True, allow_null=True
    )
    unidade_nome = serializers.CharField(
        source="id_unidade_lotacao.str_nome", read_only=True, allow_null=True
    )
...
class LotacaoJsonOrgaoSerializer(serializers.ModelSerializer):
    ...
    lotacao_versao_id = serializers.IntegerField(
        source="id_lotacao_versao.id_lotacao_versao", read_only=True
    )
    organograma_versao_id = serializers.IntegerField(
        source="id_organograma_versao.id_organograma_versao", read_only=True
    )
...
class LotacaoInconsistenciaSerializer(serializers.ModelSerializer):
    ...
    lotacao_orgao = serializers.CharField(
        source="id_lotacao.id_orgao_lotacao.str_sigla", read_only=True
    )
...
class TokenEnvioCargaSerializer(serializers.ModelSerializer):
    ...
    status_descricao = serializers.CharField(
        source="id_status_token_envio_carga.str_descricao", read_only=True
    )
...
class DetalheStatusCargaSerializer(serializers.ModelSerializer):
    ...
    status_descricao = serializers.CharField(
        source="id_status_carga.str_descricao", read_only=True
    )
    status_sucesso = serializers.IntegerField(
        source="id_status_carga.flg_sucesso", read_only=True
    )
