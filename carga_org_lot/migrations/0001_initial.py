...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_lotacao_versao",
                    models.BigAutoField(
                        db_column="idlotacaoversao", primary_key=True, serialize=False
                    ),
                ),
                ("str_origem", models.CharField(db_column="strorigem", max_length=50)),
                (
                    "str_tipo_arquivo_original",
                    models.CharField(
                        blank=True,
                ...
                (
                    ...
                    models.DateTimeField(
                        db_column="datprocessamento", default=django.utils.timezone.now
                    ),
                ),
                (
                ...
                (
                    "str_mensagem_processamento",
                    models.TextField(
                        blank=True, db_column="strmensagemprocessamento", null=True
                    ),
                ),
            ...
            fields=[
                (
                    ...
                    models.SmallIntegerField(
                        db_column="idstatuscarga", primary_key=True, serialize=False
                    ),
                ),
                (
                    "str_descricao",
                    models.CharField(db_column="strdescricao", max_length=150),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_status_progresso",
                    models.SmallIntegerField(
                        db_column="idstatusprogresso", primary_key=True, serialize=False
                    ),
                ),
                (
                    "str_descricao",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_tipo_carga",
                    models.SmallIntegerField(
                        db_column="idtipocarga", primary_key=True, serialize=False
                    ),
                ),
                (
                    "str_descricao",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_lotacao",
                    models.BigAutoField(
                        db_column="idlotacao", primary_key=True, serialize=False
                    ),
                ),
                (
                    "str_cpf",
                    models.CharField(
                        db_column="strcpf", help_text="CPF do servidor", max_length=14
                    ),
                ),
                (
                    "str_cargo_original",
                ...
                (
                    "flg_valido",
                    models.BooleanField(db_column="flgvalido", default=True),
                ),
                (
                    "str_erros_validacao",
                    models.TextField(
                        blank=True, db_column="strerrosvalidacao", null=True
                    ),
                ),
                (
                    "dat_referencia",
                    models.DateField(blank=True, db_column="datreferencia", null=True),
                ),
                (
                    "dat_criacao",
                    models.DateTimeField(
                        db_column="datcriacao", default=django.utils.timezone.now
                    ),
                ),
                (
                    "dat_alteracao",
                    models.DateTimeField(
                        blank=True, db_column="datalteracao", null=True
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="carga_org_lot.tbllotacaoversao",
                    ),
                ),
                (
                    "id_organograma_versao",
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="lotacoes",
                        to="carga_org_lot.tblorganogramaversao",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_inconsistencia",
                    models.BigAutoField(
                        db_column="idinconsistencia", primary_key=True, serialize=False
                    ),
                ),
                ...
                (
                    "dat_registro",
                    models.DateTimeField(
                        db_column="datregistro", default=django.utils.timezone.now
                    ),
                ),
                (
                    "id_lotacao",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_organograma_json",
                    models.BigAutoField(
                        db_column="idorganogramajson", primary_key=True, serialize=False
                    ),
                ),
                ...
                (
                    "dat_envio_api",
                    models.DateTimeField(
                        blank=True, db_column="datenvioapi", null=True
                    ),
                ),
                (
                    "str_status_envio",
                    models.CharField(
                        blank=True, db_column="strstatusenvio", max_length=30, null=True
                    ),
                ),
                (
                    "str_mensagem_retorno",
                    models.TextField(
                        blank=True, db_column="strmensagemretorno", null=True
                    ),
                ),
                (
                    "id_organograma_versao",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_orgao_unidade",
                    models.BigAutoField(
                        db_column="idorgaounidade", primary_key=True, serialize=False
                    ),
                ),
                (
                    "str_nome",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="carga_org_lot.tblorgaounidade",
                    ),
                ),
                (
                    "id_usuario_alteracao",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_patriarca",
                    models.BigAutoField(
                        db_column="idpatriarca", primary_key=True, serialize=False
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="carga_org_lot.tblstatusprogresso",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_lotacao_json_orgao",
                    models.BigAutoField(
                        db_column="idlotacaojsonorgao",
                        primary_key=True,
                        serialize=False,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_carga_patriarca",
                    models.BigAutoField(
                        db_column="idcargapatriarca", primary_key=True, serialize=False
                    ),
                ),
                (
                    "str_mensagem_retorno",
                ...
                (
                    "dat_data_hora_inicio",
                    models.DateTimeField(
                        db_column="datdatahorainicio", default=django.utils.timezone.now
                    ),
                ),
                (
                    "dat_data_hora_fim",
                    models.DateTimeField(
                        blank=True, db_column="datdatahorafim", null=True
                    ),
                ),
                (
                    "id_patriarca",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="cargas",
                        to="carga_org_lot.tblstatuscarga",
                    ),
                ),
                (
                    "id_tipo_carga",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    ...
                    models.BigAutoField(
                        db_column="iddetalhestatuscarga",
                        primary_key=True,
                        serialize=False,
                    ),
                ),
                ...
                (
                    "str_mensagem",
                    models.TextField(blank=True, db_column="strmensagem", null=True),
                ),
                (
                    "id_carga_patriarca",
                    models.ForeignKey(
                        ...
                        to="carga_org_lot.tblcargapatriarca",
                    ),
                ),
                (
                    "id_status_carga",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    ...
                    models.BigAutoField(
                        db_column="idtokenenviocarga", primary_key=True, serialize=False
                    ),
                ),
                (
                    "str_token_retorno",
                    models.CharField(db_column="strtokenretorno", max_length=1000),
                ),
                (
                    "dat_data_hora_inicio",
                    models.DateTimeField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="tokens",
                        to="carga_org_lot.tblstatustokenenviocarga",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.CASCADE,
                related_name="cargas",
                to="carga_org_lot.tbltokenenviocarga",
            ),
        ),
    ]
