...
class OrganogramaVersao(models.Model):
...
class OrganogramaJson(models.Model):
    ...
    def __str__(self):
        return f"JSON Organograma v{self.id_organograma_versao.pk}"


class LotacaoVersao(models.Model):
    """Versão da lotação"""
...
class LotacaoJsonOrgao(models.Model):
...
class LotacaoInconsistencia(models.Model):
    ...
    def __str__(self):
        return f"{self.str_tipo} - Lotação {self.id_lotacao.pk}"


class StatusTokenEnvioCarga(models.Model):
...
class TokenEnvioCarga(models.Model):
...
class CargaPatriarca(models.Model):
    """Carga do patriarca"""
...
class DetalheStatusCarga(models.Model):
