...
class TblStatusProgresso(models.Model):
    ...
    id_status_progresso = models.SmallIntegerField(
        primary_key=True, db_column="idstatusprogresso"
    )
...
class TblPatriarca(models.Model):
    ...
    str_nome = models.CharField(
        max_length=255, db_column="strnome", help_text="Nome completo do patriarca"
    )
    ...
    dat_criacao = models.DateTimeField(db_column="datcriacao", default=timezone.now)
    ...
    dat_alteracao = models.DateTimeField(
        null=True, blank=True, db_column="datalteracao"
    )
        ...
        if self.str_nome:
            ...
            if len(self.str_nome) < 3:
                raise ValidationError(
                    {"str_nome": "Nome deve ter pelo menos 3 caracteres"}
                )
...
class TblOrganogramaVersao(models.Model):
    ...
    id_organograma_versao = models.BigAutoField(
        primary_key=True, db_column="idorganogramaversao"
    )
    ...
    str_tipo_arquivo_original = models.CharField(
        max_length=20, null=True, blank=True, db_column="strtipoarquivooriginal"
    )
    str_nome_arquivo_original = models.CharField(
        max_length=255, null=True, blank=True, db_column="strnomearquivooriginal"
    )
    dat_processamento = models.DateTimeField(
        db_column="datprocessamento", default=timezone.now
    )
    ...
    str_mensagem_processamento = models.TextField(
        null=True, blank=True, db_column="strmensagemprocessamento"
    )
    flg_ativo = models.BooleanField(
        db_column="flgativo", default=False, help_text="Indica se esta é a versão ativa"
    )
...
class TblOrgaoUnidade(models.Model):
    ...
    str_nome = models.CharField(
        max_length=255, db_column="strnome", help_text="Nome completo do órgão/unidade"
    )
    str_sigla = models.CharField(
        max_length=50, db_column="strsigla", help_text="Sigla do órgão/unidade"
    )
...
class TblOrganogramaJson(models.Model):
    ...
    id_organograma_json = models.BigAutoField(
        primary_key=True, db_column="idorganogramajson"
    )
    ...
    str_status_envio = models.CharField(
        max_length=30, null=True, blank=True, db_column="strstatusenvio"
    )
    str_mensagem_retorno = models.TextField(
        null=True, blank=True, db_column="strmensagemretorno"
    )
...
class TblLotacaoVersao(models.Model):
    ...
    id_lotacao_versao = models.BigAutoField(
        primary_key=True, db_column="idlotacaoversao"
    )
    id_patriarca = models.ForeignKey(
        TblPatriarca,
        on_delete=models.CASCADE,
...
class TblLotacao(models.Model):
    ...
    str_cpf = models.CharField(
        max_length=14, db_column="strcpf", help_text="CPF do servidor"
    )
    str_cargo_original = models.CharField(
        max_length=255, null=True, blank=True, db_column="strcargooriginal"
    )
    str_cargo_normalizado = models.CharField(
        max_length=255, null=True, blank=True, db_column="strcargonormalizado"
    )
    flg_valido = models.BooleanField(db_column="flgvalido", default=True)
    str_erros_validacao = models.TextField(
        null=True, blank=True, db_column="strerrosvalidacao"
    )
...
class TblLotacaoJsonOrgao(models.Model):
    ...
    id_lotacao_json_orgao = models.BigAutoField(
        primary_key=True, db_column="idlotacaojsonorgao"
    )
    id_lotacao_versao = models.ForeignKey(
        TblLotacaoVersao,
        on_delete=models.CASCADE,
...
class TblLotacaoInconsistencia(models.Model):
    ...
    id_inconsistencia = models.BigAutoField(
        primary_key=True, db_column="idinconsistencia"
    )
    ...
    dat_registro = models.DateTimeField(db_column="datregistro", default=timezone.now)
...
class TblStatusTokenEnvioCarga(models.Model):
    ...
    id_status_token_envio_carga = models.SmallIntegerField(
        primary_key=True, db_column="idstatustokenenviocarga"
    )
    str_descricao = models.CharField(max_length=100, db_column="strdescricao")
...
class TblTokenEnvioCarga(models.Model):
    ...
    id_token_envio_carga = models.BigAutoField(
        primary_key=True, db_column="idtokenenviocarga"
    )
    id_patriarca = models.ForeignKey(
        TblPatriarca,
        on_delete=models.CASCADE,
    ...
    dat_data_hora_inicio = models.DateTimeField(
        db_column="datdatahorainicio", default=timezone.now
    )
    dat_data_hora_fim = models.DateTimeField(
        null=True, blank=True, db_column="datdatahorafim"
    )
...
class TblStatusCarga(models.Model):
    ...
    id_status_carga = models.SmallIntegerField(
        primary_key=True, db_column="idstatuscarga"
    )
...
class TblCargaPatriarca(models.Model):
    ...
    id_carga_patriarca = models.BigAutoField(
        primary_key=True, db_column="idcargapatriarca"
    )
    id_patriarca = models.ForeignKey(
        TblPatriarca,
        on_delete=models.CASCADE,
...
class TblDetalheStatusCarga(models.Model):
    ...
    id_detalhe_status_carga = models.BigAutoField(
        primary_key=True, db_column="iddetalhestatuscarga"
    )
