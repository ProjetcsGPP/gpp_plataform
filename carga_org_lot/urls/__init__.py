...
urlpatterns = [
    ...
    path(
        "patriarcas/<int:pk>/editar/",
        web_views.patriarca_update,
        name="patriarca_update",
    ),
    path(
        "patriarcas/<int:pk>/selecionar/",
        web_views.patriarca_select,
        name="patriarca_select",
    ),
    path(
        "patriarcas/<int:pk>/reset/", web_views.patriarca_reset, name="patriarca_reset"
    ),
    # ========================================
    # ORGANOGRAMA
    # ========================================
    ...
    path(
        "organogramas/<int:organograma_id>/",
        web_views.organograma_detail,
        name="organograma_detail",
    ),
    path(
        "organogramas/<int:organograma_id>/hierarquia/json/",
        web_views.organograma_hierarquia_json,
        name="organograma_hierarquia_json",
    ),
    # ========================================
    # LOTAÇÃO
    # ========================================
    ...
    path(
        "lotacoes/<int:lotacao_versao_id>/",
        web_views.lotacao_detail,
        name="lotacao_detail",
    ),
    path(
        "lotacoes/<int:lotacao_versao_id>/inconsistencias/",
        web_views.lotacao_inconsistencias,
        name="lotacao_inconsistencias",
    ),
    # ========================================
    # CARGAS
    # ========================================
    ...
    path(
        "upload/organograma/",
        web_views.upload_organograma_handler,
        name="upload_organograma",
    ),
