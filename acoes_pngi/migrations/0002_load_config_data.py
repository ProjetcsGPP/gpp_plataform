...
def load_tipo_anotacao_alinhamento(apps, schema_editor):
    ...
    data = [
        {'idtipoanotacaoalinhamento': 1, 'strdescricaotipoanotacaoalinhamento': 'Reunião'},
        {'idtipoanotacaoalinhamento': 2, 'strdescricaotipoanotacaoalinhamento': 'E-mail'},
        {'idtipoanotacaoalinhamento': 3, 'strdescricaotipoanotacaoalinhamento': 'Ofício'},
    ]
    for item in data:
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(load_situacao_acao, reverse_code=migrations.RunPython.noop),
        migrations.RunPython(load_tipo_entrave_alerta, reverse_code=migrations.RunPython.noop),
        migrations.RunPython(load_eixos, reverse_code=migrations.RunPython.noop),
        migrations.RunPython(load_vigencia_pngi, reverse_code=migrations.RunPython.noop),
        migrations.RunPython(load_tipo_anotacao_alinhamento, reverse_code=migrations.RunPython.noop),
    ]
