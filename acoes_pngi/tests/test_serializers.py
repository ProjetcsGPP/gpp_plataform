...
from acoes_pngi.serializers import EixoSerializer, VigenciaPNGISerializer
...
class EixoSerializerTest(BaseTestCase):
    ...
    def test_serialize_eixo(self):
        ...
        eixo = Eixo.objects.create(strdescricaoeixo="Governança Digital", stralias="GD")
    ...
    def test_create_eixo(self):
        ...
        data = {"strdescricaoeixo": "Transformação Digital", "stralias": "TD"}
