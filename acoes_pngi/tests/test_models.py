...
class EixoModelTest(BaseTestCase):
    ...
    def test_create_eixo(self):
        ...
        eixo = Eixo.objects.create(
            strdescricaoeixo="Transformação Digital", stralias="TD"
        )
    ...
    def test_eixo_str(self):
        ...
        eixo = Eixo.objects.create(strdescricaoeixo="Teste", stralias="TST")
...
class VigenciaPNGIModelTest(BaseTestCase):
    ...
    def test_vigencia_esta_vigente(self):
        ...
        if hasattr(vig_atual, "esta_vigente"):
            ...
            self.assertTrue(
                vig_atual.datiniciovigencia <= hoje <= vig_atual.datfinalvigencia
            )
            self.assertFalse(
                vig_futura.datiniciovigencia <= hoje <= vig_futura.datfinalvigencia
            )
            self.assertFalse(
                vig_passada.datiniciovigencia <= hoje <= vig_passada.datfinalvigencia
            )
...
class AcoesModelTest(BaseTestCase):
    ...
    def test_create_acao(self):
        ...
        data_entrega = make_aware(
            datetime.combine(date(2026, 6, 30), datetime.min.time())
        )
    ...
    def test_acao_str(self):
        """Teste do método __str__"""
        acao = self.create_acao_base(strapelido="ACAO-TEST", strdescricaoacao="Teste")
...
class AcaoPrazoModelTest(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.acao = self.create_acao_base(
            strapelido="ACAO-001", strdescricaoacao="Teste"
        )

    def test_create_prazo(self):
        """Teste de criação de prazo"""
        prazo = AcaoPrazo.objects.create(
            idacao=self.acao, strprazo="2026-06-30", isacaoprazoativo=True
        )
    ...
    def test_prazo_str_inativo(self):
        ...
        prazo = AcaoPrazo.objects.create(
            idacao=self.acao, strprazo="2026-06-30", isacaoprazoativo=False
        )
...
class UsuarioResponsavelModelTest(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            email="teste@seger.es.gov.br", name="Usuário Teste", password="senha123"
        )
    ...
    def test_create_usuario_responsavel(self):
        ...
        responsavel = UsuarioResponsavel.objects.create(
            idusuario=self.user, strtelefone="27999999999", strorgao="SEGER"
        )
    ...
    def test_usuario_responsavel_str_sem_orgao(self):
        ...
        responsavel = UsuarioResponsavel.objects.create(
            idusuario=self.user, strtelefone="27999999999", strorgao=""
        )
...
class RelacaoAcaoUsuarioResponsavelModelTest(BaseTestCase):
    ...
    def setUp(self):
        ...
        user = User.objects.create_user(
            email="teste@seger.es.gov.br", name="Teste", password="senha123"
        )
        ...
        self.responsavel = UsuarioResponsavel.objects.create(
            idusuario=user, strtelefone="27999999999", strorgao="SEGER"
        )

    def test_create_relacao(self):
        """Teste de criação de relação"""
        relacao = RelacaoAcaoUsuarioResponsavel.objects.create(
            idacao=self.acao, idusuarioresponsavel=self.responsavel
        )
