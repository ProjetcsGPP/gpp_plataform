...
class BaseAPITestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        for role_name, role_obj in [
            ...
            UserRole.objects.create(user=user, aplicacao=self.app, role=role_obj)
    ...
    def setup_test_data(self):
        ...
        if not hasattr(self, "eixo") or self.eixo is None:
            self.eixo = Eixo.objects.get_or_create(
                stralias="E1", strdescricaoeixo="Eixo 1 - Gestão"
            )
...
class TipoAnotacaoAlinhamentoAPITests(BaseAPITestCase):
    ...
    def setup_test_data(self):
        ...
        if not hasattr(self, "eixo") or self.eixo is None:
            self.eixo, _ = Eixo.objects.get_or_create(
                stralias="E1", defaults={"strdescricaoeixo": "Eixo 1 - Gestão"}
            )
    ...
    def test_coordenador_can_create_tipo_anotacao(self):
        ...
        self.authenticate_as("coordenador")
        data = {"strdescricaotipoanotacaoalinhamento": "Videoconferência"}
        response = self.client.post(
            "/api/v1/acoes_pngi/tipos-anotacao-alinhamento/", data, format="json"
        )
    ...
    def test_coordenador_can_update_tipo_anotacao(self):
        ...
        self.authenticate_as("coordenador")
        data = {
            "strdescricaotipoanotacaoalinhamento": "Reunião de Alinhamento - Atualizado"
        }
    ...
    def test_gestor_can_manage_tipos_anotacao(self):
        ...
        # CREATE
        data = {"strdescricaotipoanotacaoalinhamento": "E-mail"}
        response = self.client.post(
            "/api/v1/acoes_pngi/tipos-anotacao-alinhamento/", data, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_operador_cannot_create_tipo_anotacao(self):
        ...
        data = {"strdescricaotipoanotacaoalinhamento": "Tentativa Operador"}
        response = self.client.post(
            "/api/v1/acoes_pngi/tipos-anotacao-alinhamento/", data, format="json"
        )
    ...
    def test_consultor_cannot_create_tipo_anotacao(self):
        ...
        self.authenticate_as("consultor")
        data = {"strdescricaotipoanotacaoalinhamento": "Tentativa Consultor"}
        response = self.client.post(
            "/api/v1/acoes_pngi/tipos-anotacao-alinhamento/", data, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
...
class AcaoAnotacaoAlinhamentoAPITests(BaseAPITestCase):
    ...
    def setup_test_data(self):
        ...
        self.acao = Acoes.objects.create(
            ...
            idsituacaoacao=self.situacao_base,  # Adicionar para consistência
        )
    ...
    def test_coordenador_can_create_anotacao(self):
        ...
        response = self.client.post(
            "/api/v1/acoes_pngi/anotacoes-alinhamento/", data, format="json"
        )
        self.assertIn(
    ...
    def test_search_anotacoes(self):
        ...
        self.authenticate_as("consultor")
        response = self.client.get(
            "/api/v1/acoes_pngi/anotacoes-alinhamento/?search=Teste"
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class UsuarioResponsavelAPITests(BaseAPITestCase):
    ...
    def test_coordenador_can_delete_responsavel(self):
        ...
        user_temp = User.objects.create_user(
            email="temp.resp@seger.es.gov.br", name="Temp", password="senha123"
        )
        resp_temp = UsuarioResponsavel.objects.create(
            idusuario=user_temp, strorgao="TEMP"
        )
    ...
    def test_consultor_cannot_create_responsavel(self):
        ...
        self.authenticate_as("consultor")
        data = {"idusuario": novo_user.id, "strorgao": "TESTE"}
        response = self.client.post(
            "/api/v1/acoes_pngi/usuarios-responsaveis/", data, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
    ...
    def test_search_responsaveis(self):
        ...
        self.authenticate_as("consultor")
        response = self.client.get(
            "/api/v1/acoes_pngi/usuarios-responsaveis/?search=Responsável"
        )
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class RelacaoAcaoUsuarioResponsavelAPITests(BaseAPITestCase):
    ...
    def setup_test_data(self):
        ...
        user_resp = User.objects.create_user(
            email="responsavel@seger.es.gov.br", name="Responsável", password="senha123"
        )

        # ✅ 6. Criar UsuarioResponsavel vinculado ao User
        self.responsavel = UsuarioResponsavel.objects.create(
            idusuario=user_resp,
            strorgao="SEGER",  # OBRIGATÓRIO
        )
    ...
    def test_coordenador_can_create_relacao(self):
        ...
        novo_user = User.objects.create_user(
            email="novo.resp@seger.es.gov.br", name="Novo", password="senha123"
        )
        novo_resp = UsuarioResponsavel.objects.create(
            idusuario=novo_user, strorgao="SEDU"
        )
