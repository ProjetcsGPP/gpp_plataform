...
from ..models import AcaoDestaque, AcaoPrazo, Acoes, TipoEntraveAlerta
...
class AcoesWebViewsTest(BaseTestCase):
    ...
    def test_acoes_list_search(self):
        ...
        try:
            response = self.client.get(
                reverse("acoes_pngi:acoes_list"), {"search": "ACAO-001"}
            )
            self.assertIn(response.status_code, [200, 302, 404, 500])
        except Exception:
            pass
    ...
    def test_acoes_detail_requires_login(self):
        ...
        try:
            response = self.client.get(
                reverse("acoes_pngi:acoes_detail", kwargs={"idacao": self.acao.idacao})
            )
            self.assertIn(response.status_code, [302, 403])
        except Exception:
            pass
    ...
    def test_acoes_delete_get_requires_login(self):
        ...
        try:
            response = self.client.get(
                reverse("acoes_pngi:acoes_delete", kwargs={"idacao": self.acao.idacao})
            )
            self.assertIn(response.status_code, [302, 403])
        except Exception:
            pass
    ...
    def test_acoes_delete_post_success(self):
        ...
        try:
            response = self.client.post(
                reverse("acoes_pngi:acoes_delete", kwargs={"idacao": acao_id})
            )
            self.assertIn(response.status_code, [200, 302, 404, 500])
...
class AcaoPrazoWebViewsTest(BaseTestCase):
    ...
    def test_prazo_detail_get_authenticated(self):
        ...
        try:
            response = self.client.get(
                reverse(
                    "acoes_pngi:acaoprazo_detail",
                    kwargs={"idacaoprazo": self.prazo.idacaoprazo},
                )
            )
            self.assertIn(response.status_code, [200, 302, 404, 500])
        except Exception:
    ...
    def test_prazo_delete_post_success(self):
        ...
        try:
            response = self.client.post(
                reverse("acoes_pngi:acaoprazo_delete", kwargs={"idacaoprazo": prazo_id})
            )
            self.assertIn(response.status_code, [200, 302, 404, 500])
...
class AcaoDestaqueWebViewsTest(BaseTestCase):
    ...
    def test_destaque_detail_get_authenticated(self):
        ...
        try:
            response = self.client.get(
                reverse(
                    "acoes_pngi:acaodestaque_detail",
                    kwargs={"idacaodestaque": self.destaque.idacaodestaque},
                )
            )
            self.assertIn(response.status_code, [200, 302, 404, 500])
        except Exception:
    ...
    def test_destaque_create_post_success(self):
        ...
        data = {"idacao": self.acao.idacao, "datdatadestaque": "2026-03-01 15:00:00"}
        try:
    ...
    def test_destaque_update_post_success(self):
        ...
        data = {"idacao": self.acao.idacao, "datdatadestaque": "2026-02-20 12:00:00"}
        try:
            response = self.client.post(
                reverse(
                    "acoes_pngi:acaodestaque_update",
                    kwargs={"idacaodestaque": self.destaque.idacaodestaque},
                ),
                data,
            )
    ...
    def test_destaque_delete_post_success(self):
        ...
        try:
            response = self.client.post(
                reverse(
                    "acoes_pngi:acaodestaque_delete",
                    kwargs={"idacaodestaque": destaque_id},
                )
            )
            self.assertIn(response.status_code, [200, 302, 404, 500])
