...
router.register(
    r"tipos-entrave-alerta", TipoEntraveAlertaViewSet, basename="tipoentravealerta"
)
...
# Alinhamento
router.register(
    r"tipos-anotacao-alinhamento",
    TipoAnotacaoAlinhamentoViewSet,
    basename="tipoanotacaoalinhamento",
)
router.register(
    r"acoes-anotacao-alinhamento",
    AcaoAnotacaoAlinhamentoViewSet,
    basename="acaoanotacaoalinhamento",
)

# ALIAS para retrocompatibilidade com testes antigos
router.register(
    r"anotacoes-alinhamento",
    AcaoAnotacaoAlinhamentoViewSet,
    basename="anotacaoalinhamento",
)  # Alias

# Responsáveis
router.register(
    r"usuarios-responsaveis", UsuarioResponsavelViewSet, basename="usuarioresponsavel"
)
router.register(
    r"relacoes-acao-responsavel",
    RelacaoAcaoUsuarioResponsavelViewSet,
    basename="relacaoacaousuarioresponsavel",
)
...
urlpatterns = [
    ...
    path(
        "usuarios-acoes-por-acao/",
        UsuariosPorAcaoAPIView.as_view(),
        name="usuarios-por-acao",
    ),
    # ===== VIEWSETS (Router) =====
