        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(
                        db_column="stremail", max_length=200, unique=True
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, db_column="date_joined", null=True
                    ),
                ),
                (
                    "idstatususuario",
                    models.SmallIntegerField(db_column="idstatususuario", default=1),
                ),
                (
                    "idtipousuario",
                    models.SmallIntegerField(db_column="idtipousuario", default=1),
                ),
                (
                    "idclassificacaousuario",
                    models.SmallIntegerField(
                        db_column="idclassificacaousuario", default=1
                    ),
                ),
            ],
            options={
