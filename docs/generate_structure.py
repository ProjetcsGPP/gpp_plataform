...
class AppStructureAnalyzer:
    ...
    def generate_markdown(self, output_file):
        ...
        with open(output_file, "w", encoding="utf-8") as f:
            f.write("# 📦 Estrutura de Aplicacoes\n\n")
            f.write(
    ...
    def generate_json(self, output_file):
        ...
        data = {"timestamp": datetime.now().isoformat(), "apps": []}
...
def main():
    parser = argparse.ArgumentParser(
        description="Gera documentacao da estrutura de apps"
    )
    parser.add_argument(
        "--output", default="docs/app_structure", help="Diretorio de saida"
    )
    parser.add_argument(
        "--format",
